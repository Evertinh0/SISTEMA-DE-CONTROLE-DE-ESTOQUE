 ...
 * @author Everton yan
 */
public class JaneleJava extends javax.swing.JFrame {

    /**
     * Creates new form JaneleJava
     */
    public JaneleJava() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JaneleJava.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JaneleJava().setVisible(true);
            }
        });
    }
